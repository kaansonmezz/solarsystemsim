...
#
get_filename_component(filename "/home/garth/solar/build-test/_deps/cspice-subbuild/cspice-populate-prefix/src/archive.tar" ABSOLUTE)
get_filename_component(directory "/home/garth/solar/build-test/_deps/cspice-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cspice-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cspice-populate${i}")
